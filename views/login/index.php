...
<div id="wrapper-1" style="display: block;">
    ...
    <div class="row auth-wrapper gx-0">
        <div class="col-lg-7 col-xl-8 bg-primary auth-box-2 on-sidebar hidden-md-down" style="background-image:url(<?php echo URL; ?>public/images/background/restaurant.jpg); background-size: cover;">
        ...
        <div class="col-md-12 col-lg-5 col-xl-4 d-flex align-items-center justify-content-center">
            <div class="row justify-content-center w-100 mt-1 mt-lg-0 px-5">
                <div class="col-12">
                    <div id="loginform">
                        <img src="<?php echo URL; ?>public/images/logo.png" style="width: 80%;max-width: 350px;margin: 0 auto;display: block;" class="mb-2"/>
                        <h3 class="text-center">Bienvenido!</h3>
                        <p  class="text-center text-muted fs-4" style="color: dark;" >Ingrese sus datos de acceso</p>
                    ...
                    <div class="text-center" style="font-size: 12px;">Grupo WebTech Todos los derechos	reservados</div>
                </div>
            </div>
        </div>
    </div>
