...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="<?php echo URL; ?>public/images/logo.png">
    <link rel="apple-touch-icon" sizes="57x57" href="<?php echo URL; ?>public/images/logo.png">
    <link rel="apple-touch-icon" sizes="60x60" href="<?php echo URL; ?>public/images/logo.png">
    <link rel="apple-touch-icon" sizes="72x72" href="<?php echo URL; ?>public/images/logo.png">
    <link rel="apple-touch-icon" sizes="76x76" href="<?php echo URL; ?>public/images/logo.png">
    <link rel="apple-touch-icon" sizes="114x114" href="<?php echo URL; ?>public/images/logo.png">
    <link rel="apple-touch-icon" sizes="120x120" href="<?php echo URL; ?>public/images/logo.png">
    <link rel="apple-touch-icon" sizes="144x144" href="<?php echo URL; ?>public/images/logo.png">
    <link rel="apple-touch-icon" sizes="152x152" href="<?php echo URL; ?>public/images/logo.png">
    <link rel="apple-touch-icon" sizes="180x180" href="<?php echo URL; ?>public/images/logo.png">
    <link rel="icon" type="image/png" sizes="192x192"  href="<?php echo URL; ?>public/images/logo.png">
    <link rel="icon" type="image/png" sizes="32x32" href="<?php echo URL; ?>public/images/logo.png">
    <link rel="icon" type="image/png" sizes="96x96" href="<?php echo URL; ?>public/images/logo.png">
    <link rel="icon" type="image/png" sizes="16x16" href="<?php echo URL; ?>public/images/logo.png">
    <link rel="manifest" href="<?php echo URL; ?>public/images/favicons/manifest.json?v=<?php echo date('ymd'); ?>">
    <meta name="msapplication-TileColor" content="#ffffff">
    <meta name="msapplication-TileImage" content="<?php echo URL; ?>public/images/logo.png">
    <meta name="theme-color" content="#ffffff">
    <?php
        if (isset($this->title_page))
        {
            echo '<title>NOMBRE EMPRESA | '.$this->title_page.'</title>';
        }
        else{
            echo '<title>NOMBRE EMPRESA</title>';
        }
    ?>
            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-light">
                ...
                <div class="navbar-header">
                    ...
                    <?php } ?>
                        <!-- Logo icon -->
                        <b>
                            <img src="<?php echo URL; ?>public/images/logo.png" width="35px"/>
                        </b>
                        <!--End Logo icon -->
                        <!-- Logo text -->
                        <span>
