    ...
    <section id="wrapper" class="error-page" >
        <div class="error-box">
            ...
            <h1 class="text-danger m-b-0"> <img src="<?php echo URL; ?>public/images/faltapago.png" width="250px" alt=""></h1>
                ...
                <p class="text-muted m-t-0 m-b-30">Su plataforma fue bloqueada por falta de pago. Comuniquese al 999 999 999 o en el siguiente link ⬇</p>
                <a href="##" class="btn btn-success btn-rounded waves-effect waves-light m-b-40"><i class="fab fa-whatsapp"></i> CONTACTAR</a></div>
                <footer class="footer text-center bg-dark"><img src="<?php echo URL; ?>public/images/logo.png"  alt=""></div></footer>
        </div>
    </section>
</body>
<style>
